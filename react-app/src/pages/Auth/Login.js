	...
	return (
		<div className="authPage">
			<div className="authLogoContainer">
				<img alt="Poke Logo" src="/poke-crown.svg" className="authLogoImg" />
				<h1 className="authLogo bg-gradient-to-r from-[#ff960b] to-[#ffbe08] bg-clip-text text-transparent">Pokédex</h1>
			</div>
			<form className="authContainer" onSubmit={handleSubmit}>
				<h1 className="authTitle">¡HELLO POKEMON TRAINER!</h1>
				<Form.Control
					type="text"
					placeholder="Username"
					className="me-2 authInput"
					aria-label="Username"
					name="username"
					required
				/>
				...
				<p>
					To get started, please. <Link to="/register">Register</Link>
				</p>
				<br />
